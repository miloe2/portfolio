...
const Navigator = () => {
    return (
        ...
        <div className='w-full h-20  fixed top-0 z-0 overflow-x-hidden box-border flex justify-between overflow-hidden'>
            ...
            <div className='relative  w-1/3 flex text-xs text-center items-center font-bold text-white'>
                <div className='w-20 py-4 mx-2 '>Home</div>
                <div className='w-20 py-4 mx-2 '>Exhibitions</div>
                <div className='w-20 py-4 mx-2 '>Develop</div>
