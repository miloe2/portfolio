...
export const skills = {
  ...
  type: 'icon',
  desc : [
    { title: '프레임워크', content: 'vue/nuxt, react/next' },
    { title: '상태관리', content: 'vuex/pinia, zustand' },
    { title: '스타일링', content: 'SCSS, tailwind, styled-components' },
    { title: 'UI개발툴', content: 'storybook, figma, zeplin' },
  ],
};
